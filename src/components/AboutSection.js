      ...
      <div className="text-center font-semibold font-mono flex justify-center">
        <div className="w-[21rem] sm:w-[34rem] mt-4">
          ...
          <p className="text-slate-200 mt-20 leading-relaxed">
            As a developer, I’m driven by a deep passion for crafting
            thoughtful, scalable solutions to complex digital problems. Here’s a
            look into the experiences and values that shape my work:
          </p>
        </div>
      </div>
